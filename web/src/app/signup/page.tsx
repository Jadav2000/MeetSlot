...
import { Mail, Lock, User, ArrowRight, Calendar, CheckCircle2 } from "lucide-react";
      ...
      <div className="relative hidden w-1/2 flex-col justify-between bg-primary p-12 lg:flex">
        ...
        <div className="relative z-10">
          <h2 className="text-4xl font-bold leading-tight text-white">
            Join the scheduling <br />
            <span className="text-white/60">revolution today.</span>
          </h2>
        ...
        <div className="w-full max-w-[400px] space-y-8">
          <div className="text-center lg:text-left">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Get started with your free MeetSlot account.
            </p>
          </div>
